    ...
    data_overlay(),
      (function () {
        if (e('[data-dsn-temp="light"]').length > 0) {
          ...
          t.length <= 0
            ? i.addClass("menu-light")
            : t.hasClass("header-hero-2") && i.addClass("menu-light");
        ...
        return {
          ...
          loader: function (t, n) {
            ...
            i.removeClass("dsn-effect-animate"),
              this.main_root.load(t + " main.main-root > *", function (
                i,
                o,
                s
              ) {
          ...
          ajaxLoaderElemnt: function (e) {
            e
              ? i.addClass("dsn-ajax-effect")
              : i.removeClass("dsn-ajax-effect");
          },
        };
      })(r).ajaxLoad(),
      (function (t) {
      ...
      (function () {
        ...
        n.each(function (t) {
          ...
          n.on("mouseenter", function () {
            ...
            if (t.hasClass("dsn-active") || i.hasClass("dsn-ajax-effect"))
              return;
  ...
  function n() {
    ...
    return {
      ...
      isScroller: function (e) {
        ...
        let t =
          !i.hasClass("dsn-effect-scroll") || this.isMobile() || null === n;
      ...
      unlocked: function () {
        i.removeClass("locked-scroll"),
          this.start(),
          r.allInt(),
          dsnGrid.progressCircle(s);
      },
      ...
      start: function () {
        if (
          ...
          e(".scroll-to").on("click", function (t) {
            t.preventDefault();
            let n = a;
            s.isScroller(!0) && (n = s.getScrollbar()),
              TweenLite.to(n, 1.5, {
          ...
          if (
            ...
            s.length > 0 &&
              d
                ...
                .to(
                  o.find(".slider-header.slider-header-top"),
                  1,
                  { force3D: !0, height: 0 },
                  0
                ),
          ...
          e('[data-dsn-grid="move-up"]').each(function () {
            ...
            if (a.length > 0) {
              ...
              if (a.hasClass("has-top-bottom")) {
                ...
                1 !== i
                  ? (a.css("top", 0),
                    (r = TweenMax.to(a, 2, { force3D: !0, scale: t, y: e })))
                  : (r = TweenMax.to(a, 1, {
                      force3D: !0,
                      scale: t,
                      y: e,
        ...
        moveSection: function () {
          e('[data-dsn-grid="move-section"]').each(function () {
            ...
            let i = dsnGrid.getUndefinedVal(n.data("dsn-move"), -100),
              ...
              r = dsnGrid.getUndefinedVal(
                n.data("dsn-opacity"),
                n.css("opacity")
              ),
              l = dsnGrid.getUndefinedVal(n.data("dsn-duration"), "150%");
            if ("tablet" === n.data("dsn-responsive") && a.width() < 992)
              return;
